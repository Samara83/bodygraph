...
*/
function makeBodygraphRequestWithRetry($url, $maxTries = 8, $waitSeconds = 2) {
    $result = null;
...
*/
function makeDivineRequestWithRetry($url, $params, $bearerToken, $isSuccess, $maxTries = 8, $waitSeconds = 2) {
    $result = null;
    for ($attempt = 1; $attempt <= $maxTries; $attempt++) {
